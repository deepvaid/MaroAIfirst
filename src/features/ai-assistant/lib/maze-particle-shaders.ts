/** Vertex/fragment shaders from mazehq.com (particles-vertex-shader / particles-fragment-shader). */
export const MAZE_PARTICLES_VERTEX_SHADER = /* glsl */ `
...
export const MAZE_PARTICLES_FRAGMENT_SHADER = /* glsl */ `
