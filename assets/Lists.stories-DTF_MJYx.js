import{N as r}from"./iframe-DScATqdl.js";import"./preload-helper-PPVm8Dsz.js";const p={title:"Archive/Legacy Base/Lists",component:r,tags:["autodocs"],argTypes:{lines:{control:"select",options:[!1,"one","two","three"],description:"Number of text lines per item",table:{category:"Appearance",defaultValue:"one"}},density:{control:"select",options:["default","comfortable","compact"],description:"Vertical spacing density",table:{category:"Appearance",defaultValue:"default"}},nav:{control:"boolean",description:"Enables nav styles with rounded items",table:{category:"Appearance",defaultValue:!1}},disabled:{control:"boolean",description:"Disables the entire list",table:{category:"State",defaultValue:!1}},bgColor:{control:"text",description:"Background color",table:{category:"Appearance",defaultValue:""}}},args:{lines:"one",density:"default",nav:!1,disabled:!1,bgColor:""},parameters:{docs:{description:{component:`
# Lists
