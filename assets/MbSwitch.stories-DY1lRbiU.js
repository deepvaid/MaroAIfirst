import{r as d,w as n}from"./iframe-DScATqdl.js";import{_ as i}from"./MbSwitch-_VHPyiDT.js";import"./preload-helper-PPVm8Dsz.js";const m=["default","hover","focus","pressed","disabled","error"],o=["md","sm"],b={title:"Forms/MbSwitch",component:i,tags:["autodocs"],args:{modelValue:!1,indeterminate:!1,loading:!1,size:"md",state:"default",label:"Label",caption:"",hint:"Hint text",errorMessage:"Error message",disabled:!1},argTypes:{size:{control:"inline-radio",options:o},state:{control:"inline-radio",options:m}},render:e=>({components:{MbSwitch:i},setup(){const r=d(!!e.modelValue),l=d(!!e.indeterminate);return n(()=>e.modelValue,a=>{r.value=!!a}),n(()=>e.indeterminate,a=>{l.value=!!a}),{args:e,checked:r,indeterminate:l}},template:`
