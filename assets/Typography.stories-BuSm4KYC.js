import{j as s,f as a,k as i,l as o,m as e}from"./iframe-Dzs8NioN.js";import"./preload-helper-PPVm8Dsz.js";const l={title:"Foundations/Typography",component:e,tags:["autodocs"],parameters:{docs:{description:{component:`
...
6. **Accessibility**: Ensure color contrast meets WCAG AA standards (4.5:1 for body, 3:1 for large text)
        `}}}},t={render:()=>({components:{VContainer:e,VRow:o,VCol:i,VCard:a,VCardText:s},template:`
...
}`,...t.parameters?.docs?.source}}};const d=["AllTypography"];export{t as AllTypography,d as __namedExportsOrder,l as default};
