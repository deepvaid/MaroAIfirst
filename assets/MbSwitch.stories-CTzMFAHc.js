import{_ as s}from"./MbSwitch-DENXtkVU.js";import{v as t}from"./visual-meta-DVsEdd8r.js";import"./iframe-Dzs8NioN.js";import"./preload-helper-PPVm8Dsz.js";const a=[{id:"md",label:"MD"},{id:"sm",label:"SM"}],i=[{id:"default",label:"Default"},{id:"hover",label:"Hover"},{id:"focus",label:"Focus"},{id:"pressed",label:"Pressed"},{id:"disabled",label:"Disabled"},{id:"error",label:"Error"}],o={title:"Archive/Visual Parity/MbSwitch",tags:["autodocs"],render:()=>({components:{MbSwitch:s},setup(){return{sizes:a,states:i}},template:`
