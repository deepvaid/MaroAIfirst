import{j as a,f as s,k as t,l as i,m as e}from"./iframe-DScATqdl.js";import"./preload-helper-PPVm8Dsz.js";const u={title:"Foundations/Spacing",component:e,tags:["autodocs"],parameters:{docs:{description:{component:`
# Spacing & Layout
...
7. **Whitespace**: Don't underestimate whitespace; it improves readability and cognitive load
        `}}}},l=[{name:"XS",value:4,class:"pa-1"},{name:"SM",value:8,class:"pa-2"},{name:"MD",value:12,class:"pa-3"},{name:"LG",value:16,class:"pa-4"},{name:"XL",value:20,class:"pa-5"},{name:"2XL",value:24,class:"pa-6"},{name:"3XL",value:28,class:"pa-7"},{name:"4XL",value:32,class:"pa-8"},{name:"5XL",value:40,class:"pa-10"},{name:"6XL",value:48,class:"pa-12"},{name:"7XL",value:64,class:"pa-16"}],c=[{name:"None",value:0,class:"rounded-0"},{name:"Small",value:4,class:"rounded-sm",desc:"Buttons, chips"},{name:"Medium",value:8,class:"rounded",desc:"Cards, input fields"},{name:"Large",value:12,class:"rounded-lg",desc:"Dialogs, containers"},{name:"Extra Large",value:16,class:"rounded-xl",desc:"Large modals"},{name:"Full",value:9999,class:"rounded-pill",desc:"Avatars, badges"}],n={render:()=>({components:{VContainer:e,VRow:i,VCol:t,VCard:s,VCardText:a},template:`
    ...
    `,setup(){return{spacingValues:l}}})},p={render:()=>({components:{VContainer:e,VRow:i,VCol:t,VCard:s,VCardText:a},template:`
      <v-container class="py-8">
    ...
    `})},o={render:()=>({components:{VContainer:e,VRow:i,VCol:t,VCard:s,VCardText:a},template:`
      <v-container class="py-8">
    ...
    `,setup(){return{radiusValues:c}}})},d={render:()=>({components:{VContainer:e,VRow:i,VCol:t,VCard:s,VCardText:a},template:`
      <v-container class="py-8">
    ...
    `})},r={render:()=>({components:{VContainer:e,VRow:i,VCol:t,VCard:s,VCardText:a},template:`
      <v-container class="py-8">
...
}`,...r.parameters?.docs?.source}}};const v=["SpacingScale","GapUtilities","BorderRadius","LayoutDimensions","CombinedSpacingExample"];export{o as BorderRadius,r as CombinedSpacingExample,p as GapUtilities,d as LayoutDimensions,n as SpacingScale,v as __namedExportsOrder,u as default};
