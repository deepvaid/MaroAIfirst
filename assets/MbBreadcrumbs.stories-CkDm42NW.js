import{r as i,w as l}from"./iframe-Dzs8NioN.js";import{_ as o}from"./MbBreadcrumbs-D-Jbebg9.js";import"./preload-helper-PPVm8Dsz.js";const d=["default","hover","focus","disabled"],n=[{id:"home",label:"Home",icon:"home",iconOnly:!0,ariaLabel:"Home"},{id:"products",label:"Products"},{id:"more",label:"..."},{id:"lifestyle",label:"Lifestyle"},{id:"outdoors",label:"Outdoors"},{id:"hiking",label:"Hiking"}],p={title:"Navigation/MbBreadcrumbs",component:o,tags:["autodocs"],args:{items:n,modelValue:"hiking",state:"default",disabled:!1,ariaLabel:"Breadcrumb"},argTypes:{state:{control:"inline-radio",options:d}},render:t=>({components:{MbBreadcrumbs:o},setup(){const s=i(t.modelValue??"hiking");return l(()=>t.modelValue,r=>{s.value=r??"hiking"}),{args:t,selected:s}},template:`
