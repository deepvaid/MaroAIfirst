import{r as o,w as n}from"./iframe-Dzs8NioN.js";import{_ as i}from"./MbCheckbox-pcjjYmmp.js";import"./preload-helper-PPVm8Dsz.js";const d=["default","hover","focus","pressed","disabled","error"],m=["lg","md","sm"],p={title:"Forms/MbCheckbox",component:i,tags:["autodocs"],args:{modelValue:!0,indeterminate:!1,size:"lg",state:"default",label:"Label",caption:"",hint:"Hint text",errorMessage:"Error message",required:!1,disabled:!1},argTypes:{size:{control:"inline-radio",options:m},state:{control:"inline-radio",options:d}},render:e=>({components:{MbCheckbox:i},setup(){const r=o(!!e.modelValue),l=o(!!e.indeterminate);return n(()=>e.modelValue,a=>{r.value=!!a}),n(()=>e.indeterminate,a=>{l.value=!!a}),{args:e,checked:r,indeterminate:l}},template:`
