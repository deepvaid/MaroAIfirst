import{r as o,w as d}from"./iframe-DScATqdl.js";import{_ as t}from"./MbRadio-CSVXBF-g.js";import"./preload-helper-PPVm8Dsz.js";const n=["default","hover","focus","pressed","disabled","error"],r=["lg","md","sm"],c={title:"Forms/MbRadio",component:t,tags:["autodocs"],args:{modelValue:!1,size:"lg",state:"default",label:"Label",caption:"",hint:"Hint text",errorMessage:"Error message",allowDeselect:!1,required:!1,disabled:!1},argTypes:{size:{control:"inline-radio",options:r},state:{control:"inline-radio",options:n}},render:a=>({components:{MbRadio:t},setup(){const i=o(!!a.modelValue);return d(()=>a.modelValue,l=>{i.value=!!l}),{args:a,checked:i}},template:`
