import{_ as t}from"./MbButton-DwFXGSOR.js";import{v as i}from"./visual-meta-DVsEdd8r.js";import"./iframe-DScATqdl.js";import"./preload-helper-PPVm8Dsz.js";const a=[{id:"filled",label:"Filled"},{id:"outline",label:"Outline"},{id:"tinted",label:"Tinted"},{id:"plain",label:"Plain"}],l=[{id:"default",label:"Default"},{id:"hover",label:"Hover"},{id:"active",label:"Active"},{id:"focus",label:"Focus"},{id:"disabled",label:"Disabled"},{id:"loading",label:"Loading"}],s=[{id:"lg",label:"LG"},{id:"md",label:"MD"},{id:"sm",label:"SM"}],r=[{id:"with-label",label:"With Label"},{id:"icon-only",label:"Icon Only"}],m={title:"Archive/Visual Parity/MbButton",tags:["autodocs"],components:{MbButton:t},render:()=>({components:{MbButton:t},setup(){return{styles:a,states:l,sizes:s,iconModes:r}},template:`
    ...
    `})},e={parameters:i({figmaNodeId:"1902:151171",viewport:"desktop",theme:"light",state:"matrix",variant:"primary-full"})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
...
}`,...e.parameters?.docs?.source}}};const p=["Matrix"];export{e as Matrix,p as __namedExportsOrder,m as default};
