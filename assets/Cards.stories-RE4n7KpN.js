import{f as i}from"./iframe-DScATqdl.js";import"./preload-helper-PPVm8Dsz.js";const l={title:"Archive/Legacy Base/Cards",component:i,tags:["autodocs"],argTypes:{title:{control:"text",description:"Card title displayed in the v-card-item.",table:{category:"Content"}},subtitle:{control:"text",description:"Card subtitle displayed below the title.",table:{category:"Content"}},text:{control:"text",description:"Card body text content.",table:{category:"Content"}},variant:{control:"select",options:["flat","tonal","outlined","elevated","text","plain"],description:"Visual style. **Flat + border** is the Maropost design system default.",table:{category:"Appearance",defaultValue:{summary:"flat"}}},color:{control:"select",options:["","primary","secondary","success","warning","error","info"],description:"Color applied when using the tonal variant.",table:{category:"Appearance",defaultValue:{summary:"—"}}},rounded:{control:"select",options:["0","sm","md","lg","xl","pill"],description:"Border-radius preset. Maropost default is xl.",table:{category:"Appearance",defaultValue:{summary:"xl"}}},border:{control:"boolean",description:'Adds a subtle border. Always use alongside variant="flat".',table:{category:"Appearance",defaultValue:{summary:"true"}}},hover:{control:"boolean",description:"Applies hover effect — use for clickable cards.",table:{category:"Behavior",defaultValue:{summary:"false"}}},elevation:{control:{type:"range",min:0,max:24,step:1},description:"Box-shadow level. Keep at 0 for the Maropost flat design.",table:{category:"Appearance",defaultValue:{summary:"0"}}}},args:{title:"Card Title",subtitle:"Supporting subtitle text",text:"Cards contain content and actions about a single subject. Use flat + border for almost all standard content areas.",variant:"flat",color:"",rounded:"xl",border:!0,hover:!1,elevation:0},parameters:{docs:{description:{component:"### Overview\nCards contain content and actions about a single subject. They are used to group related information and make it easy to digest.\n\nUse the **Playground** story below to interactively configure card properties via the Controls panel.\n\n### 🟢 Do's\n- **Do** use the `flat` variant with a `border` for almost all standard content areas. This is the Maropost design system default.\n- **Do** use `tonal` variants for highlighting specific metrics, statuses, or state-changes.\n- **Do** use clear visual hierarchy within cards (e.g., `text-overline` for metric titles, `text-h4` for the main value).\n\n### 🔴 Don'ts\n- **Don't** use elevation shadows on cards. Our design system relies on flat borders to keep the UI clean and modern.\n- **Don't** nest cards too deeply inside other cards. Use dividers or spacing to separate content instead.\n- **Don't** overcrowd cards with too many actions. Limit primary actions to 1–2 buttons in a `v-card-actions` block.\n\n### 💡 Best Practices\n- **Interactivity:** If a card is fully clickable, add the `hover` prop so users get visual feedback.\n- **Corner Radii:** Use `rounded=\"xl\"` (the Maropost default). Do not apply `rounded=\"0\"` unless cards are edge-to-edge on mobile.\n- **Padding:** Maintain consistent padding. The standard is `pa-5` or `pa-6` for main content areas."}}}},s={render:n=>({setup(){return{args:n}},template:`
      <v-card
    ...
    `,setup(){return{items:[{color:"primary",icon:"zap",label:"Primary"},{color:"success",icon:"circle-check",label:"Success"},{color:"warning",icon:"triangle-alert",label:"Warning"},{color:"error",icon:"circle-x",label:"Error"}]}}}),parameters:{controls:{disable:!0}}},r={render:()=>({template:`
      <v-row dense>
    ...
    `,setup(){return{items:[{icon:"store",title:"Store Setup",desc:"Configure your online store channels",color:"primary"},{icon:"send",title:"Email Campaigns",desc:"Create and send targeted campaigns",color:"secondary"},{icon:"line-chart",title:"Analytics",desc:"Track performance and engagement metrics",color:"success"}]}}}),parameters:{controls:{disable:!0}}},o={render:()=>({template:`
    ...
    `,setup(){return{orders:[{num:"#10042",name:"James Anderson",amount:"$284.00",status:"Completed"},{num:"#10041",name:"Sofia Martinez",amount:"$156.50",status:"Processing"},{num:"#10040",name:"Liam Johnson",amount:"$89.99",status:"Shipped"}]}}}),parameters:{controls:{disable:!0}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  render: args => ({
    setup() {
      return {
        args
...
}`,...e.parameters?.docs?.source},description:{story:"Flat+border (default), tonal, and outlined variants.",...e.parameters?.docs?.description}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <v-row dense>
        <v-col cols="6" md="3">
...
}`,...t.parameters?.docs?.source},description:{story:"Dashboard KPI cards with trend indicators.",...t.parameters?.docs?.description}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <v-row dense>
        <v-col v-for="item in items" :key="item.color" cols="12" md="3">
...
}`,...a.parameters?.docs?.source},description:{story:"Tonal color accent cards for status highlights.",...a.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <v-row dense>
        <v-col v-for="item in items" :key="item.title" cols="12" md="4">
    ...
    setup() {
      return {
        items: [{
          icon: 'store',
          title: 'Store Setup',
          desc: 'Configure your online store channels',
          color: 'primary'
        }, {
          icon: 'send',
          title: 'Email Campaigns',
          desc: 'Create and send targeted campaigns',
          color: 'secondary'
        }, {
          icon: 'line-chart',
          title: 'Analytics',
          desc: 'Track performance and engagement metrics',
          color: 'success'
        }]
      };
    }
...
}`,...r.parameters?.docs?.source},description:{story:"Cards with hover effect for navigation or selection.",...r.parameters?.docs?.description}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <v-card variant="flat" border rounded="xl" style="max-width: 480px;">
        <div class="d-flex align-center justify-space-between px-5 pt-4 pb-3 border-b">
...
}`,...o.parameters?.docs?.source},description:{story:"Card with inline header actions — common data widget pattern.",...o.parameters?.docs?.description}}};const v=["Playground","Variants","KpiCards","ColorAccent","Clickable","WithHeaderActions"];export{r as Clickable,a as ColorAccent,t as KpiCards,s as Playground,e as Variants,o as WithHeaderActions,v as __namedExportsOrder,l as default};
