import{M as t}from"./MpKpiCard-D6Sro6tN.js";import"./iframe-DScATqdl.js";import"./preload-helper-PPVm8Dsz.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const i={title:"Data Display/MpKpiCard",component:t,tags:["autodocs"],parameters:{docs:{description:{component:`
### Overview
...
- **Typography:** The main value handles very large numbers automatically, but it's best practice to format your inputs cleanly (e.g., "1.2M" instead of "1,200,000" if space is tight).
        `}}},argTypes:{label:{control:"text"},value:{control:"text"},icon:{control:"text"},color:{control:"select",options:["primary","success","warning","error","secondary"]},trend:{control:"text"},trendPositive:{control:"boolean"},subStat:{control:"text"}}},e={args:{label:"Total Revenue",value:"$12,430",icon:"dollar-sign",color:"success",trend:"+12.5%",trendPositive:!0,subStat:"vs last month"}},o={args:{label:"Bounce Rate",value:"4.2%",icon:"mail-warning",color:"error",trend:"-2.1%",trendPositive:!1,subStat:"vs last week"}},r={args:{label:"Active Campaigns",value:"8",icon:"megaphone",color:"primary"}},a={render:()=>({components:{MpKpiCard:t},template:`
      <v-row>
...
}`,...a.parameters?.docs?.source}}};const d=["Default","NegativeTrend","NoTrend","DashboardRow"];export{a as DashboardRow,e as Default,o as NegativeTrend,r as NoTrend,d as __namedExportsOrder,i as default};
