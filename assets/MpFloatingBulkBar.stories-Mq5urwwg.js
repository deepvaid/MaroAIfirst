import{_ as t}from"./MpFloatingBulkBar-Y1jIL7PE.js";import{r as a}from"./iframe-Dzs8NioN.js";import"./preload-helper-PPVm8Dsz.js";const s={title:"Feedback/MpFloatingBulkBar",component:t,tags:["autodocs"],parameters:{docs:{description:{component:`
### Overview
...
- **Z-Index:** This component uses \`position: fixed\` and needs to float above page content. Ensure page footers don't obscure it.
        `}}},argTypes:{count:{control:{type:"number",min:0,max:100}}}},e={render:()=>({components:{MpFloatingBulkBar:t},setup(){return{count:a(5)}},template:`
    ...
    `}),args:{}},n={args:{count:3},render:o=>({components:{MpFloatingBulkBar:t},setup:()=>({args:o}),template:`
      <div style="min-height: 200px; position: relative;">
...
}`,...n.parameters?.docs?.source}}};const c=["Default","WithThreeSelected"];export{e as Default,n as WithThreeSelected,c as __namedExportsOrder,s as default};
