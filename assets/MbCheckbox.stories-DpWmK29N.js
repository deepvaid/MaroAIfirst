import{_ as a}from"./MbCheckbox-Dm-Rbp5L.js";import{v as t}from"./visual-meta-DVsEdd8r.js";import"./iframe-DScATqdl.js";import"./preload-helper-PPVm8Dsz.js";const i=[{id:"lg",label:"LG"},{id:"md",label:"MD"},{id:"sm",label:"SM"}],s=[{id:"default",label:"Default"},{id:"hover",label:"Hover"},{id:"focus",label:"Focus"},{id:"pressed",label:"Pressed"},{id:"disabled",label:"Disabled"},{id:"error",label:"Error"}],o={title:"Archive/Visual Parity/MbCheckbox",tags:["autodocs"],render:()=>({components:{MbCheckbox:a},setup(){return{sizes:i,states:s}},template:`
