import{j as a,f as s,k as o,l as t,m as e,n as m,o as d,p,q as v,s as u,t as x,v as b,x as f,y,z as g,A as h,B as w}from"./iframe-Dzs8NioN.js";import"./preload-helper-PPVm8Dsz.js";const _={title:"Foundations/Colors",component:e,tags:["autodocs"],parameters:{docs:{description:{component:`
# Color Palette
...
7. **Theme Support**: Test all colors in both light and dark theme modes
        `}}}},C=[{name:"Primary",value:m,class:"bg-primary"},{name:"Primary Darken 1",value:d,class:"bg-primary-darken-1"},{name:"Secondary",value:p,class:"bg-secondary"},{name:"Secondary Darken 1",value:v,class:"bg-secondary-darken-1"}],S=[{name:"Success",value:u,class:"bg-success"},{name:"Warning",value:x,class:"bg-warning"},{name:"Error",value:b,class:"bg-error"},{name:"Info",value:f,class:"bg-info"}],k=[{name:"Background",value:y,class:"bg-background"},{name:"Surface",value:g,class:"bg-surface"},{name:"Surface Variant",value:h,class:"bg-surface-variant"},{name:"Border",value:w,class:"bg-surface"}],r={render:()=>({components:{VContainer:e,VRow:t,VCol:o,VCard:s,VCardText:a},template:`
    ...
    `,setup(){return{colorSwatches:C}}})},n={render:()=>({components:{VContainer:e,VRow:t,VCol:o,VCard:s,VCardText:a},template:`
      <v-container class="py-8">
    ...
    `,setup(){return{semanticColors:S}}})},c={render:()=>({components:{VContainer:e,VRow:t,VCol:o,VCard:s,VCardText:a},template:`
      <v-container class="py-8">
    ...
    `,setup(){return{surfaceColors:k}}})},l={render:()=>({components:{VContainer:e,VRow:t,VCol:o,VCard:s,VCardText:a},template:`
      <v-container class="py-8">
    ...
    `})},i={render:()=>({components:{VContainer:e,VRow:t,VCol:o,VCard:s,VCardText:a},template:`
      <v-container class="py-8">
...
}`,...i.parameters?.docs?.source}}};const D=["BrandColors","SemanticColors","SurfaceColors","OnColors","TonalVariants"];export{r as BrandColors,l as OnColors,n as SemanticColors,c as SurfaceColors,i as TonalVariants,D as __namedExportsOrder,_ as default};
