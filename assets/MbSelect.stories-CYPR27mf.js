import{v as l}from"./visual-meta-DVsEdd8r.js";const r=[{id:"outlined",label:"Outlined"},{id:"filled",label:"Filled"}],s=[{id:"default",label:"Default"},{id:"hover",label:"Hover"},{id:"focus",label:"Focus"},{id:"open",label:"Open"},{id:"selected",label:"Selected"},{id:"error",label:"Error"},{id:"disabled",label:"Disabled"}];function t(e){return e==="selected"?"United States":e==="error"?"Select a country":e==="disabled"?"Japan":"Choose country"}function o(e){return e==="error"?"A country is required to continue.":e==="open"?"Use arrow keys to move through options.":"Select your current country of residence."}const i=["United States","Canada","Japan","Germany"],b={title:"Archive/Visual Parity/MbSelect",tags:["autodocs"],render:()=>({setup(){return{variants:r,states:s,options:i,valueForState:t,helperForState:o}},template:`
    ...
    `})},a={parameters:l({figmaNodeId:"981:23648",viewport:"desktop",theme:"light",state:"matrix",variant:"all"})};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
...
}`,...a.parameters?.docs?.source}}};const n=["Matrix"];export{a as Matrix,n as __namedExportsOrder,b as default};
