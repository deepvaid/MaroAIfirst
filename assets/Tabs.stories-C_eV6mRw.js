import{S as i,r}from"./iframe-DScATqdl.js";import"./preload-helper-PPVm8Dsz.js";const d={title:"Archive/Legacy Base/Tabs",component:i,tags:["autodocs"],argTypes:{color:{control:"select",options:["primary","secondary","success","warning","error","info"],description:"Indicator bar color",table:{category:"Appearance",defaultValue:"primary"}},bgColor:{control:"text",description:"Background color",table:{category:"Appearance",defaultValue:""}},density:{control:"select",options:["default","comfortable","compact"],description:"Tab height density",table:{category:"Appearance",defaultValue:"default"}},direction:{control:"select",options:["horizontal","vertical"],description:"Tab direction",table:{category:"Layout",defaultValue:"horizontal"}},grow:{control:"boolean",description:"Tabs grow to fill available width",table:{category:"Layout",defaultValue:!1}},centered:{control:"boolean",description:"Center tabs",table:{category:"Layout",defaultValue:!1}},alignTabs:{control:"select",options:["start","center","end","title"],description:"Tab alignment",table:{category:"Layout",defaultValue:"start"}},showArrows:{control:"boolean",description:"Show scroll arrows for overflow",table:{category:"Behavior",defaultValue:!1}},fixedTabs:{control:"boolean",description:"All tabs equal width",table:{category:"Layout",defaultValue:!1}}},args:{color:"primary",bgColor:"",density:"default",direction:"horizontal",grow:!1,centered:!1,alignTabs:"start",showArrows:!1,fixedTabs:!1},parameters:{docs:{description:{component:`
# Tabs
...
- Position indicator at bottom (default) for modern look
        `}}}},a={render:t=>({setup(){const s=r("overview");return{args:t,tab:s}},template:`
      <div class="pa-6">
        <v-tabs
          v-model="tab"
          :color="args.color"
    ...
    `})},e={parameters:{controls:{disable:!0}},render:()=>({setup(){return{tab:r("tab1")}},template:`
      <div class="pa-6">
    ...
    `})},n={parameters:{controls:{disable:!0}},render:()=>({setup(){return{tab:r("home")}},template:`
      <div class="pa-6">
        <v-tabs v-model="tab">
    ...
    `})},o={parameters:{controls:{disable:!0}},render:()=>({setup(){return{tab:r("section1")}},template:`
...
}`,...o.parameters?.docs?.source}}};const l=["Playground","Default","WithIcons","Vertical"];export{e as Default,a as Playground,o as Vertical,n as WithIcons,l as __namedExportsOrder,d as default};
